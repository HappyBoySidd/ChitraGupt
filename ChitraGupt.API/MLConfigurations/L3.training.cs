...
namespace Qualytics_L3_ConsoleApp
{
    public partial class L3
    {
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.Text.FeaturizeText(inputColumnName:@"L0 Level",outputColumnName:@"L0 Level")      
                                    ...
                                    .Append(mlContext.Transforms.Concatenate(@"Features", new []{@"L0 Level",@"Reported Problem Code L1",@"Reported Problem Code L2",@"Translated Short Description",@"Translated Description"}))      
                                    ...
                                    .Append(mlContext.MulticlassClassification.Trainers.OneVersusAll(binaryEstimator: mlContext.BinaryClassification.Trainers.LbfgsLogisticRegression(new LbfgsLogisticRegressionBinaryTrainer.Options(){L1Regularization=0.22246668F,L2Regularization=0.26957262F,LabelColumnName=@"Reported Problem Code L3",FeatureColumnName=@"Features"}), labelColumnName:@"Reported Problem Code L3"))      
