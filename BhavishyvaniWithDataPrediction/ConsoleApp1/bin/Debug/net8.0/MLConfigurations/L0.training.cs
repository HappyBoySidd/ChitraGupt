...
namespace ChitraGupt_API
{
    public partial class L0
    {
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.Text.FeaturizeText(inputColumnName:@"Translated Short Description",outputColumnName:@"Translated Short Description")      
                                    ...
                                    .Append(mlContext.Transforms.Concatenate(@"Features", new []{@"Translated Short Description",@"Translated Description"}))      
                                    .Append(mlContext.Transforms.Conversion.MapValueToKey(outputColumnName:@"L0 Level",inputColumnName:@"L0 Level",addKeyValueAnnotationsAsText:false))      
                                    .Append(mlContext.MulticlassClassification.Trainers.LbfgsMaximumEntropy(new LbfgsMaximumEntropyMulticlassTrainer.Options(){L1Regularization=0.5484565F,L2Regularization=3.071176F,LabelColumnName=@"L0 Level",FeatureColumnName=@"Features"}))      
