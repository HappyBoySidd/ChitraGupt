...
namespace Qualytics_L0_ConsoleApp
{
    public partial class L0
    {
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.Text.FeaturizeText(inputColumnName:@"Translated Short Description",outputColumnName:@"Translated Short Description")      
                                    ...
                                    .Append(mlContext.MulticlassClassification.Trainers.OneVersusAll(binaryEstimator: mlContext.BinaryClassification.Trainers.LbfgsLogisticRegression(new LbfgsLogisticRegressionBinaryTrainer.Options(){L1Regularization=0.20684607F,L2Regularization=0.6845363F,LabelColumnName=@"L0 Level",FeatureColumnName=@"Features"}), labelColumnName:@"L0 Level"))      
