...
namespace BhavishyaVani
{
    public partial class L2
    {
        ...
        public class ModelOutput
        {
            ...
            [ColumnName(@"Reported Problem Code L2")]
            public uint Reported_Problem_Code_L2 { get; set; }
        ...
        private static string MLNetModelPath = Path.GetFullPath("L2.mlnet");
        ...
        private static IEnumerable<string> GetLabels(ModelOutput result)
        {
            ...
            var labelColumn = schema.GetColumnOrNull("Reported Problem Code L2");
            if (labelColumn == null)
            {
                throw new Exception("Reported Problem Code L2 column not found. Make sure the name searched for matches the name in the schema.");
            }
