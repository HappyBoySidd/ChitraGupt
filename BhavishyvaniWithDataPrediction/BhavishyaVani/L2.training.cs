    ...
    public partial class L2
    {
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.Text.FeaturizeText(inputColumnName:@"Description",outputColumnName:@"Description")      
                                    ...
                                    .Append(mlContext.Transforms.Concatenate(@"Features", new []{@"Description",@"Short Description",@"Reported Problem Code L0",@"Reported Problem Code L1"}))      
                                    ...
                                    .Append(mlContext.MulticlassClassification.Trainers.LbfgsMaximumEntropy(new LbfgsMaximumEntropyMulticlassTrainer.Options(){L1Regularization=1F,L2Regularization=1F,LabelColumnName=@"Reported Problem Code L2",FeatureColumnName=@"Features"}))      
