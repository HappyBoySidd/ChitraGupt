    ...
    public partial class L0
    {
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.Text.FeaturizeText(inputColumnName:@"Description",outputColumnName:@"Description")      
                                    ...
                                    .Append(mlContext.Transforms.Concatenate(@"Features", new []{@"Description",@"Short Description"}))      
                                    .Append(mlContext.Transforms.Conversion.MapValueToKey(outputColumnName:@"Reported Problem Code L0",inputColumnName:@"Reported Problem Code L0",addKeyValueAnnotationsAsText:false))      
                                    .Append(mlContext.MulticlassClassification.Trainers.OneVersusAll(binaryEstimator: mlContext.BinaryClassification.Trainers.LbfgsLogisticRegression(new LbfgsLogisticRegressionBinaryTrainer.Options(){L1Regularization=0.46344545F,L2Regularization=0.03125F,LabelColumnName=@"Reported Problem Code L0",FeatureColumnName=@"Features"}), labelColumnName:@"Reported Problem Code L0"))      
