...
namespace BhavishyaVani
{
    public partial class L0
    {
        ...
        public class ModelOutput
        {
            ...
            [ColumnName(@"Reported Problem Code L0")]
            public uint Reported_Problem_Code_L0 { get; set; }
        ...
        private static string MLNetModelPath = Path.GetFullPath("L0.mlnet");
        ...
        private static IEnumerable<string> GetLabels(ModelOutput result)
        {
            ...
            var labelColumn = schema.GetColumnOrNull("Reported Problem Code L0");
            if (labelColumn == null)
            {
                throw new Exception("Reported Problem Code L0 column not found. Make sure the name searched for matches the name in the schema.");
            }
