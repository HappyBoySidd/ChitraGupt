...
namespace ChitraGupt_API
{
    public partial class L0
    {
        ...
        private static string MLNetModelPath = Path.GetFullPath("Features\\Prediction\\Models\\L0\\L0.mlnet");
        ...
        private static IEnumerable<string> GetLabels(ModelOutput result)
        {
            ...
            var labelColumn = schema.GetColumnOrNull("L0 Level");
            if (labelColumn == null)
            {
                throw new Exception("L0 Level column not found. Make sure the name searched for matches the name in the schema.");
            }
