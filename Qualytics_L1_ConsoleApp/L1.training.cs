...
namespace Qualytics_L1_ConsoleApp
{
    public partial class L1
    {
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.Text.FeaturizeText(inputColumnName:@"L0 Level",outputColumnName:@"L0 Level")      
                                    ...
                                    .Append(mlContext.Transforms.Concatenate(@"Features", new []{@"L0 Level",@"Translated Short Description",@"Translated Description"}))      
                                    ...
                                    .Append(mlContext.MulticlassClassification.Trainers.OneVersusAll(binaryEstimator: mlContext.BinaryClassification.Trainers.LbfgsLogisticRegression(new LbfgsLogisticRegressionBinaryTrainer.Options(){L1Regularization=0.071533516F,L2Regularization=0.41380054F,LabelColumnName=@"Reported Problem Code L1",FeatureColumnName=@"Features"}), labelColumnName:@"Reported Problem Code L1"))      
